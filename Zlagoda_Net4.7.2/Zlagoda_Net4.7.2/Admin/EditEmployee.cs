        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (_adminrepository.IsAdmin(StaticInfo.id, StaticInfo.password))
            {
                try
                {
                    ...
                    _adminrepository.Update(employee, sha256(PasswordBox.Text));
