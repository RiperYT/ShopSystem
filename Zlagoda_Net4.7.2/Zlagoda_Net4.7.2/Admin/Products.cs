...
namespace Zlagoda_Net4._7._2.Admin
{
    public partial class Products : Form
    {
        ...
        public Products()
        {
            ...
            {
                var products = _adminrepository.ListOfProducts();
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            if (_adminrepository.IsAdmin(StaticInfo.id, StaticInfo.password))
            {
                var products = _adminrepository.ListOfProductsByNameAndCategory(NameBox.Text, CategoryBox.Text);
        ...
        private void EditButton_Click(object sender, EventArgs e)
        {
            ...
            {
                var product = new EditProduct(int.Parse(ListProducts.SelectedItems[0].Text));
                Hide();
                product.ShowDialog();
                Close();
            }
        ...
        private void DeleteButton_Click(object sender, EventArgs e)
        {
            if (_adminrepository.IsAdmin(StaticInfo.id, StaticInfo.password))
            {
                if (ListProducts.SelectedItems.Count > 0)
                {
                    try
                    {
                        _adminrepository.DeleteProduct(int.Parse(ListProducts.SelectedItems[0].Text));
